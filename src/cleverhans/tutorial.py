...
def ld_mnist():
    ...
    train_dataset = datasets.MNIST(
        "data/mnist", train=True, download=True, transform=train_transforms
    )
    test_dataset = datasets.MNIST(
        "data/mnist", train=False, download=True, transform=test_transforms
    )
